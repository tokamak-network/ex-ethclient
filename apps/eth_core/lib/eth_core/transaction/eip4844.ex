defmodule EthCore.Transaction.EIP4844 do
  ...
  def decode(<<@type_byte, rlp_payload::binary>>) do
    ...
    {:ok,
     %__MODULE__{
       ...
       max_fee_per_blob_gas: H.decode_integer(max_fee_per_blob_gas),
    ...
    e -> {:error, "Failed to decode EIP-4844 tx: #{inspect(e)}"}
  end
  ...
  def encode(%__MODULE__{} = tx) do
    rlp_payload =
      [
        ...
        H.encode_integer(tx.max_fee_per_blob_gas),
